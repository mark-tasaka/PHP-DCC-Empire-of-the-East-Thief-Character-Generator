...
<html>
<head>
<title>Launch Page: Thief Character Generator Dungeon Crawl Classics</title>
	...
	<script type="text/javascript" src="js/thiefMenu.js"></script>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Thief Character Generator Dungeon Crawl Classics" class="image" /></h1>
        ...
        <p>The Dungeon Crawl Classics Empire of the East Thief Character Generator has been designed primarily with PHP. Several  functions are stored in external files, as a means of creating greater design efficiency, with the goal of writing a program with high cohesion and low coupling. In this way, this program simulates Object-Oriented design.</p>
		...
		<div class="content8">
            ...
            <br/>
                ...
                <script>
                   ...
                   $("#ThiefFormV3").attr('action', "character/dccThief.php");
